...
<?php $page_title = "View Incident";
/*
    The purpose of this file is for viewing
...
$q_SubmissionGetFilesList = "Call spSubmissionGetFilesList($SubmissionID);"; // Call the procedure
$result = $dbc->query($q_SubmissionGetFilesList); // Run the procedure
