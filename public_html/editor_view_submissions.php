...
<tr>
	...
	<td align="left"><b><a href="view_users.php?sort=fn">Case Title</a></b></td>
	<td align="left"><b><a href="view_users.php?sort=rd">Submission Date</a></b></td>
</tr>
';
...
while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
	$bg = ($bg=='#eeeeee' ? '#ffffff' : '#eeeeee');
		echo '<tr bgcolor="' . $bg . '">
		<td align="left"><a href="download.php?id=' . $row['SubmissionID'] . '">Download Case</a></td>
