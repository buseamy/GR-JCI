            ...
            <div class="revisions">
                ...
                if ($result->num_rows > 0) { ?>
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo '<tr><td class="span3">' . $row["IncidentTitle"]. '</td> <td class="span3">' . $row["EditorName"]. '</td> <td class="span3">' . $row["SubmissionStatus"]. '</td> <td class="span2">' . $row["SubmissionDate"]. '<td class="span1"><a href="viewIncident.php?SubmissionID=' . $row["SubmissionID"] .'">View</a></td></tr>';
                    } echo "</table>";
                } else {
                    //if no results found
